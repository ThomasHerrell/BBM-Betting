	...
	<div class="banner-bottom py-5">
		<div class="d-flex container py-xl-3 py-lg-3">
			<div class="banner-left-bottom-w3ls offset-lg-2 offset-md-1">
				<h3 class="text-white my-3">Highly Regarded Doctors</h3>
				<p> All specialists have extensive practical experience and regulat training courses in educational centers of the
					world</p>
			</div>
			<div class="button">
	...
	<div class="blog-w3ls py-5" id="blog">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title text-white"> Available Donors</h3>
				<span>
...
Type O individuals are often called "universal donors" since their blood can be transfused into persons with any blood type. Those with type AB blood are called "universal recipients" because they can receive blood of any type.</p>
            ...
            <div class="col-md-4" style="padding-top: 30px;"> 
                ...
                <a class="btn btn-lg btn-secondary btn-block login-button ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3" data-toggle="modal" data-target="#exampleModalCenter1" href="#" data-toggle="modal" data-target="#exampleModalCenter1"> Help Lives! Become a Donor</a>
            </div>
        </div>
		</div>
	</div>
