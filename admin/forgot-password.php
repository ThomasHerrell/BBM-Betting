...
<head>
	...
	<title>LifeFlow Blood & Donor Management System | Forgot Password</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">LifeBlood & Donor System Forgot Password</h1>
