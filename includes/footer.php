          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Blood Donation </span>LifeFlow
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p> We are LifeFlow, our mission & motto is to make the consumption of blood readily available 
              We are the pioneers of this industry and plan on helping every patient with utmost dignity.</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">©  LifeFlow Pvt Limited.
